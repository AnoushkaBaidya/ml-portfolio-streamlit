"""
Artifact I/O helpers for the Spotify project.
"""
...
def save_spotify_artifact_bundle(
    version: str,
    model,
    preprocessors: dict,
    metrics: dict,
    ...
    """
    Save a standardized Spotify artifact bundle.
    """
...
def load_spotify_artifact_bundle(version: str | None = None) -> dict:
    """
    Load a standardized Spotify artifact bundle.
